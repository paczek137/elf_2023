...
struct Card
{
    ...
    inline static const map<char, int> labelsToValueMap = { {'A', 14}, {'K', 13}, {'Q', 12}, {'J', 11}, {'T', 10} };
    char label;
    int value;
...
struct Hand
{
    ...
    {
        // if (std::equal(cards.cbegin(), cards.cend(), cards.crbegin()))
...
int main()
{
    ...
    // string filename("example_input"); // 6440
